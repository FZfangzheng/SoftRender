...
namespace rst
{
    ...
    public:
        ...
        void set_vertex_shader(int idx, VertexShader* vs);
        void set_vertex_shadow_shader(int idx, VertexShader* vs);
        //void set_fragment_shader(const FragmentShader& fs);
        void set_fragment_shader(int idx, FragmentShader* fs);
        void set_fragment_shadow_shader(int idx, FragmentShader* fs);
    ...
    private:
        ...
        std::unordered_map<int, FragmentShader* > fragment_shader_shadow_map;
        std::unordered_map<int, VertexShader* > vertex_shader_shadow_map;
        ...
        void rasterize_triangle_shadow(int idx, const Triangle& t, const std::array<Eigen::Vector3f, 3>& world_pos);
